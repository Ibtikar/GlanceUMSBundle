...
');
   ...
   %value%
        ...
        $visitorAdd = new EmailTemplate();
        $visitorAdd->setName('add frontent user');
        $visitorAdd->setSubject('أهلاً بك مطبخ قودي');
        $visitorAdd->setMessage('لقد إنضممتِ اليوم الى عائلة مطبخ قودي، بنحن بدورنا نهنئك ونتمنى لك مزيداً من التوفيق');
        $visitorAdd->setExtraInfo('<tr>
                                                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:right; line-height: 24px;font-weight: bold;direction:rtl;">
بيانات الدخول:
                                                                    </td>
                                                                </tr>');

        $visitorAdd->setTemplate('                <tr>
                                                    <td>
