...
class StaffType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('username', formType\TextType::class, array('attr' => array('data-validate-element'=>true,'data-rule-minlength' => 5, 'data-rule-unique' => 'ibtikar_glance_ums_staff_check_field_unique', 'data-url' => $options['container']->get('router')->generate('ibtikar_glance_ums_staff_check_field_unique'), 'data-rule-unique' => 'ibtikar_glance_ums_staff_check_field_unique', 'data-name' => 'username', 'data-rule-staffUsername' => 'true', 'data-rule-maxlength' => 150)))
            ->add('email', formType\EmailType::class, array('attr' => array('data-validate-element'=>true,'data-rule-unique' => 'ibtikar_glance_ums_staff_check_field_unique', 'data-url' => $options['container']->get('router')->generate('ibtikar_glance_ums_staff_check_field_unique'), 'data-name' => 'email', 'data-rule-maxlength' => 330)))
            ->add('mobile', \Ibtikar\GlanceDashboardBundle\Form\Type\PhoneType::class,array('required' => false,'attr'=>array('data-validate-element'=>true,'parent-class'=>'phoneNumber')))
