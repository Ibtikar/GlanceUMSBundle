...
class StaffType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('mobile', \Ibtikar\GlanceDashboardBundle\Form\Type\PhoneType::class,array('required' => false,'attr'=>array('data-validate-element'=>true,'parent-class'=>'phoneNumber','data-error-message'=>$options['errorMessage']['mobileError'])))
